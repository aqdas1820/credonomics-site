...
def parse_block_row(
    ...
    return {
        ...
        "Extraction_Method": "Multi-Block Coordinate V5.1",
...
def main() -> int:
    ...
    with pd.ExcelWriter(output, engine="openpyxl") as writer:
        ...
        if not holdings.empty:
            ...
            block_summary["Weight_Quality"] = pd.cut(
                block_summary["Total_Weight"],
                bins=[-1, 20, 60, 120, 10000],
                labels=["Very Partial", "Partial", "Portfolio-like", "Suspicious High"],
            )
    ...
    print()
    print("=" * 82)
    print("CREDONOMICS MF EXTRACTOR V5.1 COMPLETE")
    print("=" * 82)
