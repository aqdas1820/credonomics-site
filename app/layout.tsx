      ...
      <body>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html:
              "(function(){try{var t=localStorage.getItem('credonomics-theme');if(t!=='light'&&t!=='dark')t='dark';document.documentElement.dataset.theme=t;}catch(e){document.documentElement.dataset.theme='dark';}})();",
          }}
        />        {children}
        <script
